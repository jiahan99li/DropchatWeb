...
<html>
        ...
        <div id="headerRight">
            <div id="navContainer">
                <ul>
                    ...
                    <a href="profile.php" id="currentPage"><li><i class="fas fa-user"></i></li></a>
                </ul>
            </div>
        </div>
    </header>
    ...
    <div id="popupBackground" onclick="document.getElementById('popupBackground').style.display='none';document.getElementById('popupSettings').style.display='none'">
    <div id="popupSettings">
        <ul>
            <a href="edit-profile.php"><li id="popupTop">Edit Profile</li></a>
            <a href="../includes/logout.inc.php"><li id="popupBottom">Logout</li></a>
        </ul>
    </div>
    </div>
    ...
    <body class="profileBody">
        <div id="profileBackground">
            <div id="profileContainer">
                <div id="profileCover">
                    <div id="changeCoverBtn">
                    
                    </div>
                    <div id="changeContainer">
                        <a href="#" id="changeLink"><i class="far fa-edit"></i></a>
                    </div>
                    <img onContextMenu='return false;' src="../images/profile/backCover.jpg" onmouseover="document.getElementById('changeCoverBtn').style.display='block';document.getElementById('changeContainer').style.display='block'" onmouseout="document.getElementById('changeCoverBtn').style.display='none';document.getElementById('changeContainer').style.display='none'">
                </div>
                ...
                <div id="profileSettings">
                    <a onclick="document.getElementById('popupBackground').style.display='block';document.getElementById('popupSettings').style.display='block'"><i class="fas fa-cog"></i></a>
                </div>
                </div>
                </div>
            </div>
                            ...
                            <div id="viewingUserPostUserInfo">
                                <div id="viewingUserPostUserInfo1">
                                    <div id="viewingUserPostUserInfoImage">
                                        <?php
                                        if ($rowImg['imgStatus'] == 0) {
                                            echo "<img onContextMenu='return false;' src='../profile-uploads/profile".$mySession.".jpg?'".mt_rand().">";
                                        } else if ($rowImg['imgStatus'] == 1) {
                                        ?>
                                            <img onContextMenu='return false;' src='../profile-uploads/DropchatProfile.jpg'>
                                        <?php
                                ...
                                <div id="viewingUserPostUserInfo3">
                                    <form action="">
                                        <button>x</button>
                                    </form>
                                    <!--<button id="ellipsisButton" onclick="document.getElementById('test').style.display='block'"><i class="fas fa-ellipsis-v"></i></button>
                                    <div id="test"></div>-->
                                </div>
                            </div>
